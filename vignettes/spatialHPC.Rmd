...
output: 
  BiocStyle::html_document:
    ...
    code_folding: show
date: "`r doc_date()`"
package: "`r pkg_ver('spatialHPC')`"
vignette: >
  %\VignetteIndexEntry{spatialHPC Tutorial}
...
Welcome to the `spatial_HPC` project! In this vignettes, we are going to show how to access the spatially-resolved transcriptomics (SRT) and single-nucleus RNA-sequencing (snRNA-seq) data from adjacent tissue sections of the anterior human hippocampus across ten adult neurotypical donors generated at the Lieber Institute for Brain Development (LIBD). 
...
`spatialHPC` is an R package available via [Bioconductor](http://bioconductor.org/) repository for packages. GitHub repository can be found [here](https://github.com/christinehou11/spatialHPC).
...
BiocManager::install("spatialHPC")
